...
class BotArcApiV5User {
  ...
  public info(
    user: string,
    fuzzy: true,
    recent?: BotArcApiRecent,
    withSongInfo?: boolean
  ): Promise<BotArcApiContentV5.User.Info>;
  public info(
    usercode: string,
    fuzzy: false,
    recent?: BotArcApiRecent,
  ...
  public info(
    usercode: string,
    fuzzy?: boolean | BotArcApiRecent,
    recent?: boolean | BotArcApiRecent,
    withSongInfo?: boolean
  ): Promise<BotArcApiContentV5.User.Info> {
    ...
    if (typeof fuzzy === "boolean") {
      ...
      const _recent =
        typeof recent === "number" && recent >= 0 && recent <= 7 ? recent : 0;
      if (_recent && _recent > 0) params.recent = _recent;
      if (withSongInfo) params.withSongInfo = true;
    } else {
      params.usercode = usercode;
      const _recent =
        typeof fuzzy === "number" && fuzzy >= 0 && fuzzy <= 7 ? fuzzy : 0;
      if (_recent && _recent > 0) params.recent = _recent;
    ...
    return new Promise<BotArcApiContentV5.User.Info>((resolve, reject) => {
      axiosInstance({
        ...
        .then((response: AxiosResponse) => {
          const data =
            response.data as BotArcApiResponseV4<BotArcApiContentV5.User.Info>;
  ...
  public best(
    ...
    withSongInfo?: boolean
  ): Promise<BotArcApiContentV5.User.Best>;
  public best(
    usercode: string,
    fuzzy: false,
    songname: string,
  ...
  public best(
    ...
    songname?: string | ArcaeaDifficulty,
    difficulty?: boolean | ArcaeaDifficulty,
    withSongInfo?: boolean
  ): Promise<BotArcApiContentV5.User.Best> {
    const axiosInstance = this.axios;
    let params: Record<string, any> = {};
    if (typeof fuzzy === "boolean") {
      ...
      params.difficulty =
        typeof difficulty === "number" && difficulty >= 0 && difficulty <= 3
          ? difficulty
          : 2;
      if (withSongInfo) params.withsonginfo = true;
    } else {
      ...
      params.difficulty =
        typeof songname === "number" && songname >= 0 && songname <= 3
          ? songname
          : 2;
    ...
    return new Promise<BotArcApiContentV5.User.Best>((resolve, reject) => {
      axiosInstance({
        ...
        .then((response: AxiosResponse) => {
          const data =
            response.data as BotArcApiResponseV4<BotArcApiContentV5.User.Best>;
          if (data.status === 0 && data.content) resolve(data.content);
  ...
  public best30(
    ...
    withSongInfo?: boolean,
    overflow?: number
  ): Promise<BotArcApiContentV5.User.Best30>;
  public best30(
    usercode: string,
    fuzzy: false,
    withSongInfo?: boolean,
  ...
  public best30(
    ...
    return new Promise<BotArcApiContentV5.User.Best30>((resolve, reject) => {
      axiosInstance({
        ...
        .then((response: AxiosResponse) => {
          const data =
            response.data as BotArcApiResponseV4<BotArcApiContentV5.User.Best30>;
          if (data.status === 0 && data.content) resolve(data.content);
          else reject(data.message || "undefined error occurred");
        })
        .catch(reject);
...
class BotArcApiV5Song {
  ...
  public info(
    songname: string,
    fuzzy: true
  ): Promise<BotArcApiDifficultyInfoV5[]>;
  public info(
    songid: string,
    fuzzy: false
  ): Promise<BotArcApiDifficultyInfoV5[]>;
  ...
  public random(
    withSongInfo?: boolean
  ): Promise<BotArcApiContentV5.Song.Random>;
  public random(
    start?: BotArcApiDifficultyRange,
    withSongInfo?: boolean
  ): Promise<BotArcApiContentV5.Song.Random>;
  public random(
    start?: BotArcApiDifficultyRange,
    end?: BotArcApiDifficultyRange
  ): Promise<BotArcApiContentV5.Song.Random>;
  public random(
    start?: BotArcApiDifficultyRange,
    end?: BotArcApiDifficultyRange,
  ...
  public random(
    start?: BotArcApiDifficultyRange | boolean,
    end?: BotArcApiDifficultyRange | boolean,
    withSongInfo?: boolean
  ): Promise<BotArcApiContentV5.Song.Random> {
    const axiosInstance = this.axios;
    ...
    return new Promise<BotArcApiContentV5.Song.Random>((resolve, reject) => {
      axiosInstance({
        ...
        .then((response: AxiosResponse) => {
          const data =
            response.data as BotArcApiResponseV4<BotArcApiContentV5.Song.Random>;
          if (data.status === 0 && data.content) resolve(data.content);
          else {
            reject(data.message || "undefined error occurred");
          }
      ...
      axiosInstance({
        ...
        .then((response: AxiosResponse<ArrayBuffer>) => {
          ...
          if (response.headers["content-type"].includes("application/json")) {
            ...
            ) as BotArcApiResponseV4<undefined>;
